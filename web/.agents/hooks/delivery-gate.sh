...
MSG="FRAME Delivery Gate: ${COUNT} source edits this session but no learning was captured today. Reflect is a required step, not optional. Run /frame:retrospective (or /frame-retrospective) or /frame:note before ending."
